...
compression_level = 9 # Optional. zstd level 1..=19; higher values log a warning and use 9. Default: 9 when `compression = "zstd"`. Server-side only; this process's encoder. Client upgrade not required. See `docs/compression.md`
