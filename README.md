...
compression_level = 9 # Optional. zstd level 1..=22. Default: 9 when `compression = "zstd"`. Server-side only. Non-default values are sent to the client on the data channel. See `docs/compression.md`
